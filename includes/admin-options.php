...
class casdoor_admin
{
                ...
                <div>
                    <form method="post" action="options.php">
                        ...
                        <tr valign="top">
                            ...
                            <tr valign="top">
                                <th scope="row">Support for WooCommerce: Redirect /my-account/edit-account/ to Casdoor</th>
                                <td>
                                    <label>
                                        <input type="checkbox"
                                            name="<?= self::OPTIONS_NAME ?>[woo_edit_account_redirect]"
                                            value="1" <?= absint(casdoor_get_option('woo_edit_account_redirect')) === 1 ? 'checked="checked"' : ''; ?> />
                                        Enable rewriting links and redirecting direct visits to Casdoor’s /account. Links open in a new tab.
                                    </label>
                                </td>
                            </tr>
                        </table>
    ...
    public function validate(array $input): array
    {
        ...
        $input['woo_edit_account_redirect']   = isset($input['woo_edit_account_redirect']) ? 1 : 0;
